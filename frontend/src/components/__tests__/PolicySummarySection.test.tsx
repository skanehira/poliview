...
describe('PolicySummarySection', () => {
  ...
  it('renders summarize button when onSummarizePolicy is provided', () => {
    ...
    expect(screen.getByRole('button', { name: '✨政策をさらに分かりやすく' })).toBeInTheDocument()
  })
  ...
  it('calls onSummarizePolicy when summarize button is clicked', async () => {
    ...
    const summarizeButton = screen.getByRole('button', { name: '✨政策をさらに分かりやすく' })
  ...
  it('shows toggle button when simplified text is available', () => {
    ...
    expect(screen.getByRole('button', { name: '要約を開く' })).toBeInTheDocument()
  })
  ...
  it('shows "要約を閉じる" when summary is open', () => {
    ...
    expect(screen.getByRole('button', { name: '要約を閉じる' })).toBeInTheDocument()
  })
  ...
  it('displays simplified summary when showSimplifiedSummary is true', () => {
    ...
    expect(screen.getByText('This is a simplified explanation')).toBeInTheDocument()
  })
  ...
  it('does not display simplified summary when showSimplifiedSummary is false', () => {
    ...
    expect(screen.queryByText('This is a simplified explanation')).not.toBeInTheDocument()
  })
